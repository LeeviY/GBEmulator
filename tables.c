...
const unsigned char insTicks[256] =
{
	...
	2, 6, 4, 4, 2, 2, 4, 4,  8, 4, 4, 4, 2, 2, 4, 4, // 0x1_
	8, 6, 4, 4, 2, 2, 4, 2,  8, 4, 4, 4, 2, 2, 4, 2, // 0x2_
	8, 6, 4, 4, 6, 6, 6, 2,  8, 4, 4, 4, 2, 2, 4, 2, // 0x3_
...
const char* opNames[256] =
{
	...
	"LD A, (0xFF00 + 0x%02)","POP AF","LD A, (0xFF00 + C)","DI","UNKNOWN","PUSH AF","OR 0x%02X","RST 0x30",
